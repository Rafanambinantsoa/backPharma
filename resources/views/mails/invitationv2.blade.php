    ...
    <style media="all" type="text/css">
        @media all {
            .btn-primary table td:hover {
                background-color: #4FD3C4 !important;
            }

            .btn-primary a:hover {
                background-color: #488FB1 !important;
                border-color: #488FB1 !important;
            }
        }
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main"
                        ...
                        <tr>
                            <td class="wrapper"
                                ...
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    Nous sommes heureux de vous informer de notre prochain événement :</p>
                                ...
                                <p
                                    style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                    N'oubliez pas de cliquer sur le bouton suivant afin de finaliser votre réservation
                                    pour l'événement.</p>
